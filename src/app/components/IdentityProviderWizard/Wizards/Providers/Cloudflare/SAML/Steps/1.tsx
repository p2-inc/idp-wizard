  ...
  const instructions: InstructionProps[] = [
    {
      text: (
        <div>
          In your Cloudflare Zero Trust dashboard, select <b>Access controls</b>{" "}
          and <b>Applications</b> from the sidebar menu, then choose{" "}
    ...
    },
    {
      text: (
        <div>
          On the <b>Add an application</b> page, select <b>SaaS</b> as the
          application type.
        </div>
      ),
    ...
    },
    {
      text: (
        <div>
          ...
          application. Set the authentication protocol to <b>SAML</b> by
          clicking the <b>Select SAML</b> button, then click{" "}
          <b>Add Application</b>.
        </div>
      ),
